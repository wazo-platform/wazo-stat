...
class TestAgentLoginTimeComputer(unittest.TestCase):
    def test__add_time_to_agent_in_period(self):
        ...
        expected_result = {dt(2012, 1, 1, 1): {1: {'pause_time': duration}}}

        computer._add_time_to_agent_in_period(
            period[dt(2012, 1, 1, 1)], agent_id, time_type, duration
        )
